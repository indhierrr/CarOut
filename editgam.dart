...
class editgamprod extends StatefulWidget {
  DocumentSnapshot docid;
  editgamprod({required this.docid});

  @override
  State<editgamprod> createState() => _editgamprodState();
}

class _editgamprodState extends State<editgamprod> {
