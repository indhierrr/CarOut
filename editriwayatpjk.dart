...
import 'package:carout/Pjk/riwayatpjk.dart';
...
class editriwayat extends StatefulWidget {
  ...
  editriwayat({required this.docid});

  @override
  _editriwayatState createState() => _editriwayatState(docid: docid);
  }

class _editriwayatState extends State<editriwayat> {
  DocumentSnapshot docid;
  _editriwayatState({required this.docid});
  ...
  void initState() {
    ...
    start = TextEditingController(text: widget.docid.get('start'));
    finish = TextEditingController(text: widget.docid.get('finish'));
    super.initState();
  }
            ...
            Container(
                      ...
                      Container(
                       ...
                       Container(
                        ...
                        Container(
                        margin: EdgeInsets.only(right: 365),
                        child: Text(
                        'Start',
                        style: TextStyle(fontSize: 10,color: Color(0xff556E68)
                        ),
                        ...
                        Container(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              border: InputBorder.none,hintText: 'Start',
                            ),
                          ),
                        ...
                        Container(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              border: InputBorder.none,hintText: 'Finish',
                            ),
                          ),
                        ),
                  ...
                  widget.docid.reference.delete().whenComplete(() {
                          Navigator.pushReplacement(
                              context, MaterialPageRoute(builder: (_) => riwayatpjk()));
                        });
                },
                            color:  Colors.grey,
                            child: Text(
