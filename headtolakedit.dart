...
class headtolakeditprod extends StatefulWidget {
  DocumentSnapshot docid;
  headtolakeditprod({required this.docid});

  @override
  _headtolakeditprodState createState() => _headtolakeditprodState();
}

class _headtolakeditprodState extends State<headtolakeditprod> {
