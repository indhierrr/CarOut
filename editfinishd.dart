...
import 'package:carout/Pjk/finishd.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

import 'package:flutter/material.dart';

class driverjalan extends StatefulWidget {
  DocumentSnapshot docid;
  driverjalan({required this.docid});

  @override
  _driverjalanState createState() => _driverjalanState();
}

class _driverjalanState extends State<driverjalan> {
  ...
  CollectionReference ref = FirebaseFirestore.instance.collection('FINISH');
